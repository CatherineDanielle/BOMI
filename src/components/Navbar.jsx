...
const Navbar = ({ isLoggedIn = false, userProfile = null, currentPage = 'home' }) => {
          ...
          <div className="hidden md:block">
            {isLoggedIn && userProfile ? (
              ...
              <button 
                ...
                className="px-6 py-2 rounded-full font-medium border-2 border-orange-300 text-green-700 hover:bg-orange-300 hover:text-white transition-all duration-200"
              >
                Login
              </button>
            )}
          ...
          <div className="flex flex-col space-y-4 pt-4">
            ...
            <div className="pt-4 border-t border-gray-100">
              {isLoggedIn && userProfile ? (
                ...
                <button 
                  className="w-full px-6 py-2 rounded-full font-medium border-2 border-orange-300 text-green-700 hover:bg-orange-300 hover:text-white transition-all duration-200"
                  onClick={() => {
