...
const FiturPost = [
    {
        ...
        desc: "Menghitung Body Mass Index (BMI) Anda dengan mudah hanya dengan memasukkan jenis kelamin, berat badan, tinggi badan, dan usia. Sistem akan menghitung BMI Anda menggunakan rumus standar dan menampilkan hasil berupa kategori BMI (kurus, normal, overweight, obesitas) serta memberikan informasi terkait status berat badan Anda."
    }
]

export default function LeftFitur () {
  return (
    <div className="bg-[#f4edd5] py-12 px-6">
      <div className="max-w-4xl mx-auto text-center mb-6 flex items-center justify-center gap-3">
        ...
        <img src={logo} alt="BOMI Logo" className="w-16 h-16" />
      </div>
